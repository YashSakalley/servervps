...
def opn():
    # change 'C:\\Users\\Shashank\\Desktop\\test\\upload\' part to your directory to store images
    # root = 'C:\\Users\\Shashank\\Desktop\\test\\upload\\Case-'
    root = 'document\\images\\Case-'

    # path for haarcascade.xml in your system
    ...
    for x, y, w, h in faces:
        ...
        dim = (int(save_img.shape[1]*scale/100),
               int(save_img.shape[0]*scale/100))
        ...
        cv2.imwrite(root+caseNumber+'/'+'Suspect-' +
                    str(sampleNumber)+'.jpg', save_img)
